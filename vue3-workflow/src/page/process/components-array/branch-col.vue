 ...
 * @LastEditors: wangjie
 * @LastEditTime: 2021-11-15 15:36:49
-->
<template>
  <div class="flow-col">
    <div class="clear-left-border" v-show="index === 0"></div>
    <div class="clear-right-border" v-show="index === total -1"></div>
    <div class="flow-row ">
      <div  class="flow-box">
            ...
            <div class="flow-node-box">
              <div class="node-name node-sp">
                ...
                <div class="search-input el-input" style="display: none;">
                  <input type="text" autocomplete="off" id="1459067251146620928" class="el-input__inner">
                </div>
          ...
          <div class="after-node-btn">
            <span>
              <span class="el-popover__reference-wrapper">
                <img src="data:image/png;base64," alt="" class="el-popover__reference" aria-describedby="el-popover-5544" tabindex="0">
              </span>
            </span>
          </div>
        </div>
