 ...
 * @LastEditors: wangjie
 * @LastEditTime: 2021-09-26 16:57:08
-->
<script lang="tsx">
import {
  defineComponent,
...
export default defineComponent({
  setup (props, { slots }) {
    ...
    const tableData = ref([
      { orderNo: 1, detailNo: 2, orderStatus: 1, state: 4, status: 5, orderNo1: 6 },
      { orderNo: 2, detailNo: 2, orderStatus: 2, state: 4, status: 5, orderNo1: 6 },
      { orderNo: 3, detailNo: 2, orderStatus: 3, state: 4, status: 5, orderNo1: 6 },
      { orderNo: 4, detailNo: 2, orderStatus: 4, state: 4, status: 5, orderNo1: 6 },
      { orderNo: 5, detailNo: 2, orderStatus: 5, state: 4, status: 5, orderNo1: 6 },
      { orderNo: 6, detailNo: 2, orderStatus: 6, state: 4, status: 5, orderNo1: 6 }
    ])
      ...
      if (slots[prop]) {
        return (
          <el-table-column label={label} prop={prop} >
            ...
            {{
              default: (scope) => {
                // console.log('el-table-column -- default', scope)
